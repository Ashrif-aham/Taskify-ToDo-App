...
export default function Todo(){
        ...
        if(editTitle.trim() !=='' && editdescription.trim() !==''){
            fetch(apiurl+"/todos/"+editId,{
                ...
                if(res.ok){
                    ...
                    setTodos([...todos,{editTitle,description}])
    ...
    return <>
       <div className="row p-3 bg-success text-light">
           <h1>Taskify-Daily Planner App</h1>
        ...
        <div className="row">
           ...
           {message && <p className="text-success">{message}</p>}
            <div className="form-group d-flex gap-2">
                <input placeholder="Title" onChange={(e) =>setTitle(e.target.value)} className="form-control" type="text" />
                <input placeholder="Description" onChange={(e) =>setDescription(e.target.value)} className="form-control" type="text" />
